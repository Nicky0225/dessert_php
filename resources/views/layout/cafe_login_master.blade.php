...
<style>
	...
	.button.text-white.bg-gradient {
		background: #B87333; /* 设置纯色背景 */
		background-image: none; /* 移除渐变效果 */
		color: #ffffff; /* 设置按钮的文字颜色 */
	}

	.button.text-white.bg-gradient.gradient-blue-green:hover {
				...
				<div class="container">
					<div class="header-row">
                        ...
                        <div class="header-misc ms-auto">
                            <a href="{{route('user.auth.home')}}" class="button text-white bg-gradient  h-op-08 rounded-4 m-0">回首頁</a>
                        </div>
						...
						<!-- Primary Navigation
						============================================= -->
						<nav class="primary-menu ms-auto with-arrows">

							<ul class="menu-container">
								<li class="menu-item">
									<a class="menu-link" href="index.html"><div>首頁</div></a>
								...
								<li class="menu-item current">
									<a class="menu-link" href="#"><div>關於我們</div></a>
									<ul class="sub-menu-container">
										<li class="menu-item">
								...
								<li class="menu-item mega-menu">
									<a class="menu-link" href="#"><div>麵包</div></a>
								...
								<li class="menu-item mega-menu">
									<a class="menu-link" href="#"><div>甜點</div></a>
									<div class="mega-menu-content mega-menu-style-2">
										<div class="container">
											<div class="row">
												<ul class="sub-menu-container mega-menu-column col">
								...
								<li class="menu-item">
									<a class="menu-link" href="shop.html"><div>餐盒自由配</div></a>
									<ul class="sub-menu-container">
										<li class="menu-item">
